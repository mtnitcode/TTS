...
namespace Sbn.Controls.EventCalendar
{
    public class Office11Renderer : AbstractRenderer
    {
        ...
        public override void DrawHourLabel(Graphics g, RectangleF rect, int hour , int step , int zoom)
        {
        ...
        public override void DrawDayHeader(Graphics g, Rectangle rect, MyDateTime date)
        {
        ...
        public override void DrawAppointment(Graphics g, Rectangle rect, Appointment appointment, bool isSelected, int gripWidth)
        {
            ...
            rect.X += gripWidth;
            g.DrawString(appointment.Title + "-" + appointment.Description.Substring(0, (appointment.Description.Length >= 30 ? 29 : appointment.Description.Length )), this.BaseFont, SystemBrushes.WindowText, rect, m_Format);
        }

        public override void DrawDayHeaderInWeekly(Graphics g, Rectangle rect, MyDateTime date)
        {
        ...
        public override void DrawDayHeaderInMontly(Graphics g, Rectangle rect, MyDateTime date)
        {
           
        }

        public override void DrawTitleHeaderInMontly(Graphics g, Rectangle rect, MyDateTime date)
        {
            throw new NotImplementedException();
        }

        public override void DrawTitleHeaderInWeekly(Graphics g, Rectangle rect, MyDateTime date)
        {
            throw new NotImplementedException();
        }
    }
