...
namespace Sbn.Controls.EventCalendar
{
    public abstract class AbstractRenderer
    {
        ...
        public abstract void DrawHourLabel(Graphics g, RectangleF rect, int hour , int Step , int zoom);

        public abstract void DrawDayHeader(Graphics g, Rectangle rect, MyDateTime date);

        public abstract void DrawDayHeaderInWeekly(Graphics g, Rectangle rect, MyDateTime date);

        public abstract void DrawDayHeaderInMontly(Graphics g, Rectangle rect, MyDateTime date);

        public abstract void DrawTitleHeaderInMontly(Graphics g, Rectangle rect, MyDateTime date);
        public abstract void DrawTitleHeaderInWeekly(Graphics g, Rectangle rect, MyDateTime date);
        ...
        public abstract void DrawAppointmentInWeekly(Graphics g, Rectangle rect, Appointment appointment, bool isSelected, int gripWidth);

        public abstract void DrawAppointmentInMonthly(Graphics g, Rectangle rect, Appointment appointment, bool isSelected, int gripWidth);
